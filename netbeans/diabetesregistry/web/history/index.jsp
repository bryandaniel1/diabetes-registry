    ...
    <section class="pagecontent">
        ...
        <c:choose>
            <c:when test="${a1cHistory != null}">
                <h3 class="historyheader">A1C History</h3>
            ...
            <c:when test="${psaHistory != null}">
                <h3 class="historyheader">PSA History</h3>
                <section class="historybox">
                    <table class="historytable">
                        <tr>
                            <th>
            ...
            <c:when test="${altHistory != null}">
                <h3 class="historyheader">ALT History</h3>
                <section class="historybox">
                    <table class="historytable">
                        <tr>
                            <th>
            ...
            <c:when test="${astHistory != null}">
                <h3 class="historyheader">AST History</h3>
                <section class="historybox">
                    <table class="historytable">
                        <tr>
                            <th>
            ...
            <c:when test="${bpHistory != null}">
                <h3 class="historyheader">Blood Pressure History</h3>
                <section class="historybox">
                    <table class="historytable">
                        <tr>
                            <th>
            ...
            <c:when test="${bmiHistory != null}">
                <h3 class="historyheader">BMI History</h3>
                <section class="historybox">
                    <table class="historytable">
                        <tr>
                            <th>
            ...
            <c:when test="${checklistItems != null}">
                <h3 class="historyheader">quality checklist tasks accomplished on <c:out value="${checklistDate}"></c:out></h3>
                    <section class="historybox">
                        <table class="historytable">
            ...
            <c:when test="${classHistory != null}">
                <h3 class="historyheader">Class Attendance</h3>
                <section class="historybox">
                    <table class="historytable">
                        <tr>
                            <td colspan="2">
                ...
                <c:when test="${creatinineHistory != null}">
                    <h3 class="historyheader">Creatinine History</h3>
                    <section class="historybox">
                        <table class="historytable">
                            <tr>
                                <th>
                ...
                <c:when test="${egfrHistory != null}">
                    <h3 class="historyheader">eGFR History</h3>
                    <section class="historybox">
                        <table class="historytable">
                            <tr>
                                <th>
                ...
                <c:when test="${eyeHistory != null}">
                    <h3 class="historyheader">Eye Screening History</h3>
                    <section class="historybox">
                        <table class="historytable">
                            <tr>
                                <th>
                ...
                <c:when test="${footHistory != null}">
                    <h3 class="historyheader">Foot Screening History</h3>
                    <section class="historybox">
                        <table class="historytable">
                            <tr>
                                <th>
                ...
                <c:when test="${glucoseHistory != null}">
                    <h3 class="historyheader">Glucose History</h3>
                    <section class="historybox">
                        <table class="historytable">
                            <tr>
                                <th>
                ...
                <c:when test="${hdlHistory != null}">
                    <h3 class="historyheader">HDL History</h3>
                    <section class="historybox">
                        <table class="historytable">
                            <tr>
                                <th>
                ...
                <c:when test="${hepBHistory != null}">
                    <h3 class="historyheader">Hepatitis B Vaccination History</h3>
                    <section class="historybox">
                        <table class="historytable">
                            <tr>
                                <th>
                ...
                <c:when test="${hospitalizationHistory != null}">
                    <h3 class="historyheader">Hospitalization History</h3>
                    <section class="historybox">
                        <table class="historytable">
                            <tr>
                                <th>
                ...
                <c:when test="${influenzaHistory != null}">
                    <h3 class="historyheader">Influenza Vaccination History</h3>
                    <section class="historybox">
                        <table class="historytable">
                            <tr>
                                <th>
                ...
                <c:when test="${ldlHistory != null}">
                    <h3 class="historyheader">LDL History</h3>
                    <section class="historybox">
                        <table class="historytable">
                            <tr>
                                <th>
                ...
                <c:when test="${complianceHistory != null}">
                    <h3 class="historyheader">Patient-reported Compliance History</h3>
                    <section class="historybox">
                        <table class="historytable">
                            <tr>
                                <th>
                ...
                <c:when test="${pcv13History != null}">
                    <h3 class="historyheader">PCV-13 Vaccination History</h3>
                    <section class="historybox">
                        <table class="historytable">
                            <tr>
                                <th>
                ...
                <c:when test="${physicalActivityHistory != null}">
                    <h3 class="historyheader">Minutes of Weekly Physical Activity History</h3>
                    <section class="historybox">
                        <table class="historytable">
                            <tr>
                                <th>
                ...
                <c:when test="${ppsv23History != null}">
                    <h3 class="historyheader">PPSV-23 Vaccination History</h3>
                    <section class="historybox">
                        <table class="historytable">
                            <tr>
                                <th>
                ...
                <c:when test="${psychologicalHistory != null}">
                    <h3 class="historyheader">Psychological Screening History</h3>
                    <section class="historybox">
                        <table class="historytable">
                            <tr>
                                <th>
                ...
                <c:when test="${smokingHistory != null}">
                    <h3 class="historyheader">Smoking Status History</h3>
                    <section class="historybox">
                        <table class="historytable">
                            <tr>
                                <th>
                ...
                <c:when test="${t4History != null}">
                    <h3 class="historyheader">T4 History</h3>
                    <section class="historybox">
                        <table class="historytable">
                            <tr>
                                <th>
                ...
                <c:when test="${tdapHistory != null}">
                    <h3 class="historyheader">TDAP Vaccination History</h3>
                    <section class="historybox">
                        <table class="historytable">
                            <tr>
                                <th>
                ...
                <c:when test="${rxHistory != null}">
                    <h3 class="historyheader">Treatment History</h3>
                    <section class="historybox">
                        <table class="historytable">
                            <tr>
                                <th colspan="4">
                ...
                <c:when test="${telephoneHistory != null}">
                    <h3 class="historyheader">Telephone Follow-up History</h3>
                    <section class="historybox">
                        <table class="historytable">
                            <tr>
                                <th>
                ...
                <c:when test="${triglyceridesHistory != null}">
                    <h3 class="historyheader">Triglycerides History</h3>
                    <section class="historybox">
                        <table class="historytable">
                            <tr>
                                <th>
                ...
                <c:when test="${tshHistory != null}">
                    <h3 class="historyheader">TSH History</h3>
                    <section class="historybox">
                        <table class="historytable">
                            <tr>
                                <th>
                ...
                <c:when test="${uacrHistory != null}">
                    <h3 class="historyheader">UACR History</h3>
                    <section class="historybox">
                        <table class="historytable">
                            <tr>
                                <th>
                ...
                <c:when test="${waistHistory != null}">
                    <h3 class="historyheader">Waist History</h3>
                    <section class="historybox">
                        <table class="historytable">
                            <tr>
                                <th>
                ...
                <c:when test="${zosterHistory != null}">
                    <h3 class="historyheader">Zoster Vaccination History</h3>
                    <section class="historybox">
                        <table class="historytable">
                            <tr>
                                <th>
            ...
            <c:if test="${dashboard != null}">
                <h3 id="dashboardheader">Patient Dashboard</h3>
            ...
            <c:choose>
                <c:when test="${a1cGraphPoints != null}">
                    <h3 class="historyheader">Line Chart</h3>
