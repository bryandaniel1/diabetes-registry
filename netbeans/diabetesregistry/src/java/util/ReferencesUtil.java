 ...
 */
public class ReferencesUtil implements ServletContextListener {

    /**
     * Executes when the context is initialized
     *
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        ReferenceContainer rc = ReferencesIO.getReferenceContainer();
