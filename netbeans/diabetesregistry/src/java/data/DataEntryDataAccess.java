...
/**
 * This class provides the ability to access the database for data entry of lab
 * measurements and other results.
 *
 * @author Bryan Daniel
 * @version 2, March 16, 2017
 */
public class DataEntryDataAccess {

    /**
     * This method connects to the database to store lab measurements and other
     * results for a patient.
     *
     * The data is given in the form of a DataEntryContainer object parameter,
     * holding variables which are accessed and used as parameters for the call
     * to the addResults stored procedure.
     *
     * @param dec the DataEntryContainer object
    ...
    public static boolean addResults(DataEntryContainer dec,
        ...
        try {
            ...
            Logger.getLogger(DataEntryDataAccess.class.getName()).log(Level.SEVERE,
                    "An exception occurred during the addResults method.", ex);
            return false;
        } finally {
