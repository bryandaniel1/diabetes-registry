...
/**
 * This class accesses the database to perform operations associated with
 * retrieving, adding, and updating patients in the registry.
 *
 * @author Bryan Daniel
...
public class PatientDataAccess {
     ...
     * @return the list of patients or null if results are missing
     */
    public static ArrayList<Patient> getPatients(int clinicId,
        ...
        try {
            ...
            Logger.getLogger(PatientDataAccess.class.getName()).log(Level.SEVERE,
    ...
    /**
     * This method updates a patient's information in the database.
     *
     ...
     * @param referenceCharacters the character string
     * @return the boolean indicating update success or failure
     */
    public static boolean updatePatient(int patientId, String firstName,
        ...
        try {
            ...
            Logger.getLogger(PatientDataAccess.class.getName()).log(Level.SEVERE,
                    "An exception occurred during the updatePatient method.", ex);
            return false;
        } finally {
            DatabaseUtility.closeCallableStatement(cs);
            pool.freeConnection(connection);
    ...
    /**
     * This method adds a new patient's information to the database.
     *
     * @param firstName the first name
     * @param lastName the last name
     * @param birthDate the birth date
    ...
    public static boolean addPatient(String firstName,
        ...
        try {
            ...
            Logger.getLogger(PatientDataAccess.class.getName()).log(Level.SEVERE,
                    "An exception occurred during the addPatient method.", ex);
        } finally {
            DatabaseUtility.closeCallableStatement(cs);
            pool.freeConnection(connection);
        }
